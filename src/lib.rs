...
#[derive(Debug)]
pub struct CipherTraceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CipherTraceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CipherTrace processing");
    
    let mut processor = CipherTraceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CipherTraceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CipherTraceProcessor::new(false);
